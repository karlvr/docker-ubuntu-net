...
sub vcl_recv {
  ...
  if (req.http.X-Supermodel-Path ~ "(\?|&)esiAllowFilters=true(&|$)") {
    ...
    set req.http.X-Supermodel-Cookies-Allowed = req.http.X-Supermodel-Cookies-Allowed + ",hideShortsFilter,hideUnreleasedFilter,hideWatchlistedFilter,watchlistFilter,watchedOrUnwatchedFilter";
  } else {
